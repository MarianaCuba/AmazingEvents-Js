...
function datosDeURl (){
    ...
    .then(dato => { console.log(dato)
        ...
        crearTarjeta(filtroEventosFuturos)
        pintarTarjetas(filtroEventosFuturos,$section);
        console.log(filtroEventosFuturos)
        CheckBoxContainer.innerHTML += categorias(listaCategorias)
        inputSearch.addEventListener("keyup", e=> pintarTarjetas(filtroCruzado(filtroEventosFuturos), $section))
        CheckBoxContainer.addEventListener("change", e => pintarTarjetas(filtroCruzado(filtroEventosFuturos),$section))
